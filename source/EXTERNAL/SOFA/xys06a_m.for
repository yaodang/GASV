      SUBROUTINE iau_XYS06A ( DATE1, DATE2, N, X, Y, S )
*+
*  - - - - - - - - - - -
*   i a u _ X Y S 0 6 A
*  - - - - - - - - - - -
...
*-----------------------------------------------------------------------
      ...
      DOUBLE PRECISION DATE1, X1, Y1, S1
	  
      DOUBLE PRECISION DATE2(N)
	  
      DOUBLE PRECISION X(N),Y(N),S(N)
...
*  Form the bias-precession-nutation matrix, IAU 2006/2000A.
        CALL iau_PNM06A ( DATE1, DATE2(I), RBPN )

*  Extract X,Y.
        CALL iau_BPN2XY ( RBPN, X1, Y1 )

*  Obtain s.
        S1 = iau_S06 ( DATE1, DATE2(I), X1, Y1 )
